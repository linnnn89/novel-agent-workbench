...
## 2026-07-26：重写面向浏览者的项目介绍

### 目标与变更

- 将 README 首屏从内部实现说明调整为面向网文作者、长篇小说作者和系列故事创作者的产品介绍。
- 明确区分产品定位、适用人群、可完成的创作任务与最新能力；保留后续本地运行、开发和实现状态说明。
- 同步更新 GitHub 仓库 About 简介，突出本地优先、长篇创作、Memory Bank、AI 审阅/改写和多模型服务支持。

### 边界

- 本次仅更新项目介绍和工作记录，不改变程序逻辑、API 请求结构或 EXE 构建产物。
- 文案明确说明草稿需要作者确认，不把项目描述成自动完成整本小说或自动发布的平台。
