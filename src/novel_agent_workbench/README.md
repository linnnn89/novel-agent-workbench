...
- `chapters.py`: metadata-only chapter workflow state for planned/drafting/draft_ready/review_ready/review_accepted/needs_revision/revision_requested/committed/blocked.
