...
from .memory_bank_window import (
    format_memory_compression_prompt,
    open_memory_bank_window,
    wrapped_row_positions,
)
...
# Keep these names available from desktop_app for callers written before the split.
from .ui_presenters import (
    ...
    is_cjk_character,
    is_empty_retriable_chapter,
    latest_draft_title,
    memory_auto_summary_range_label,
    memory_category_label,
    memory_progress_label,
    memory_progress_number,
    memory_token_advice,
    optional_float,
    optional_int,
...
class WorkbenchDesktopApp(tk.Tk):
    ...
    def _configure_style(self) -> None:
        # Preserve the class hook while the implementation lives with its theme tokens.
        configure_classic_theme(self)
    ...
    def show_memory_bank_window(self, project_id: str) -> None:
        """Compatibility entry point for the extracted Memory Bank window."""
        open_memory_bank_window(self, project_id, app_title=APP_TITLE)
